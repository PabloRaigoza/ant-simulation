...
public class TerrainGenerator : MonoBehaviour
{
    ...
    [SerializeField] int radialSegments = 254; // Number of segments around the torus' ring
    [SerializeField] int tubularSegments = 128; // Number of segments around the tube
