...
//   [NonSerialized] private Transform m_xform = null;
...
// static private void GetNearestTris(Vector3 p, float radius, Vector3[] verts, int[] tris, Vector3[] normals, Transform xform, List<Contact> result)
// {
//   result.Clear();
